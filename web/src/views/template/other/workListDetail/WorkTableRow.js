...
class WorkTableRow extends Component {
    constructor(props) {
        super(props);
        this.state = {
            detailOpen: false,
        ...
        return (
            <React.Fragment>
                <TableRow sx={{ '&:last-child .MuiTableCell-body': { border: '0px !important' } }}  className={this.state.detailOpen ? classes.showBackground :''}>
                    ...
                    <TableCell>{list.groupName}</TableCell>
                    ...
                    <TableCell>
                        <Button className={classes.checkTask} disableRipple>작업보기</Button>
                    </TableCell>
                </TableRow>
                <WorkTableDetail open={this.state.detailOpen}/>
            </React.Fragment>
        );
    }
};

export default withStyles(styles)(WorkTableRow);