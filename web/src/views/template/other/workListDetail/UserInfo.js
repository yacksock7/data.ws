    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                <TableContainer component={Paper} className={classes.UsertableBox}>
                    <Table aria-label="simple table">
                        <TableHead>
                            <TableRow>
                                <TableCell width='15%' className={classes.padding}>작업 닉네임</TableCell>
                                <TableCell width='11%'>성명</TableCell>
                                <TableCell width='14%'>작업그룹</TableCell>
                                <TableCell width='14%'>이메일</TableCell>
                                <TableCell align='center' width='10%'>성별</TableCell>
                                <TableCell width='10%'>생년월일</TableCell>
                                <TableCell width='13%'>소속</TableCell>
                                <TableCell width='13%'>가입일</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            <TableRow sx={{ '&:last-child .MuiTableCell-body': { border: 0 } }}>
                                ...
                                <TableCell >
                                    <Typography className={classes.nameText}>그룹 1+</Typography>
                                </TableCell>
