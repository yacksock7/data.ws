...
const TEMPLATE_STEP_CARDS = [
    {
        textId: TemplateStepType.Upload,
        text: '업로드',
        rejectPoint: false,
        icon: <UploadIcon/>,
        tooltip: '일감을 파일 단위로 업로드 합니다.',
        tooltip2: ''
    }, {
        textId: TemplateStepType.Editing,
        text: '교정',
        rejectPoint: true,
        icon: <CorrectionIcon/>,
        tooltip: '텍스트 (원시 데이터)를 작업자가 직접 교정',
        tooltip2: ''
    }, {
        textId: TemplateStepType.Export,
        text: '추출',
        rejectPoint: false,
        icon: <ExtractionIcon/>,
        tooltip: '모든 단계 작업이 완료되어 추출된 결과물 (Json 등)을 다운로드',
        tooltip2: ''
    }, {
        textId: TemplateStepType.Machine,
        text: '기계',
        rejectPoint: false,
        icon: <MachineTranslationIcon/>,
        tooltip: '템플릿에서 선택한 기계 작업 옵션이 자동 실행되어 결과물 출력 (1) STT: 음성을 텍스트로 변환 (2) 기계번역: 선택한 번역기로 자동 번역 (3) 문법교정기: 선택한 문법교정기에서 자동 검사 및 교정',
        tooltip2: ''
    }, {
        textId: TemplateStepType.Inspection,
        rejectPoint: false,
        text: '검수',
        icon: <InspectionIcon/>,
        tooltip: '이전 단계의 결과 데이터를 작업자가 검수 진행',
        tooltip2: '반려 가능하며 이전 단계를 지정하여 해당 단계 작업자에게 재작업을 요청'
    },
