...
// import clsx from "clsx";
class TableComponentDownload2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            page: 2,
                                    ...
                                    <Table size="small" aria-label="purchases">
                                        ...
                                        <TableBody>
                                            {row.history.map((historyRow, index) => (
                                                <TableRow key={row.no + historyRow.no}>
                                                        ...
                                                        {historyRow.assign ? (
                                                            ...
                                                            <TableCell className={classes.bgf3e9ff} align="right">
                                                                <Box style={{display: 'flex', alignItems: 'center'}}>
                                                                    {/*workTimeStyle / workTimeBlue / workTimePurple /workTimeGreen / workTimeOrange*/}
                                                            ...
                                                            <>
                                                                <TableCell className={classes.bgf3e9ff} align="right">
                                                                    <Box style={{display: 'flex', alignItems: 'center'}}>
                                                                        {/*workTimeStyle 반려 / workTimeOrange 마감 / workTimeGreen 미완료 / workTimePurple 완료*/}
                                                                        <Box className={clsx(classes.workTimeStyle, classes.workTimeOrange)}>
                                                                            <Button disableRipple></Button>
                                                                        </Box>
                                                                        <Stack className={classes.avatarBox}>
                                                                            <Avatar>
                    ...
                    <Table aria-label="collapsible table">
                        <TableHead className={classes.headTitle}>
                            <TableRow className={classes.tableList}>
                                ...
                                <TableCell style={{width: '65%'}} align="left">일감명</TableCell>
                                ...
                                <TableCell style={{width: '5%'}} align="right" className={classes.toggleBtn} colSpan={1}>
                                    <IconButton
...
export default withStyles(styles)(
    inject('jobStepStore', 'workStore', 'jobStepTaskWorkerStore', 'authStore')(
        observer(TableComponentDownload2)
    )
);
