...
import {styles} from "./styles/DashboardTableStyle";
import {
    Box, Button,
    LinearProgress,
    Paper,
                    ...
                    <Table aria-label="simple table">
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell width='20%'>작업 상태<span> (완료 건수/할당 건수)</span></TableCell>
                                <TableCell width='7%'>반려 건수</TableCell>
                                <TableCell width='10%'>
                                ...
                                <TableCell width='11%' >최근 작업 상태</TableCell>
                            ...
                            {this.state.tableList.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((list, i) => (
                                <TableRow key={i} sx={{ '&:last-child .MuiTableCell-body': { border: 0 } }}>
                                    ...
                                    <TableCell align="center" className={classes.tableBorderRight}>
                                        <Link to="/dashboard/detail" className={classes.underline}>
                                            <Button className={classes.buttonStyle} disableRipple>상세 내역</Button>
                                        </Link>
                                    </TableCell>
