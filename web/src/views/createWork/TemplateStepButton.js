...
import ChatGptLogo from "../../common/images/ChatGptLogo.png";
            ...
            <>
                                        ...
                                        <Box className={classes.optionBox}>
                                            <Box className={classes.displayFlex} justifyContent='center'
                                                ...
                                                <FormControl variant="outlined"
                                                    ...
                                                    >
                                                        <MenuItem value={0}>옵션 선택</MenuItem>
                                                        <MenuItem value={InspectionType.Record}>
                                                            녹음 검수
                                                        </MenuItem>
                                                        <MenuItem component='button'
                ...
                {(step.type && step.type === TemplateStepType.Export) &&
                    <>
                        ...
                        <Draggable key={dragKey} draggableId={dragKey} index={stepIndex} isDragDisabled={true}
                                   disableInteractiveElementBlocking>
                            {(provided, snapshot) => (
                                <div
                                    ref={provided.innerRef}
